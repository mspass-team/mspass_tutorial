#!/usr/bin/env python3
"""Measure model-only CPU inference throughput for PhaseNet-USArray."""
...
DEFAULT_OUT = SCRIPT_DIR / "throughput_model_only_cpu_usarray.json"
...
def main() -> None:
    run_benchmark(
        ...
        description="Measure PhaseNet-USArray model-only CPU throughput.",
