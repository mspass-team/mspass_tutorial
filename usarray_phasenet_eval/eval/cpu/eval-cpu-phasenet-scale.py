#!/usr/bin/env python3
"""Measure model-only CPU inference throughput for PhaseNet-Scale."""
...
DEFAULT_OUT = SCRIPT_DIR / "throughput_model_only_cpu_scale.json"
...
def main() -> None:
    run_benchmark(
        ...
        description="Measure PhaseNet-Scale model-only CPU throughput.",
